...
public class Proyecto {
    ...
    private static ArrayList<Termino> listaTermino;

    public static void main(String[] args)
    {   //por favor terminar:
        /*listaTermino = Menu.cargarListadoTermino();
        ...
        Estudiante e1 = new Estudiante("Jean Aguilar", "202108643","jcaguila@espol.edu.ec");
